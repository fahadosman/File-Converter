(function () {
  ...
  function ensureHeader() {
    ...
    if (!header) {
      ...
      wrapper.innerHTML =
        '<a href="/index.html" class="brand brand-link"><span class="brand-logo-wrap"><img class="brand-logo" src="/favicon.png" alt="File Converters logo" /></span><span>File Converters</span></a>' +
